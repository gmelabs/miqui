...
class spark1 {
  ...
  file { 'spark1_conf_dir':
    path    => '/home/spkadmin/software/spark-1.0.9-hadoop1/conf',
    ensure  => directory,
    mode    => '0755',
    owner   => 'spkadmin',
    group   => 'spark',
  ...
  file { 'spark1_fairscheduler.xml':
    path    => '/home/spkadmin/software/spark-1.0.9-hadoop1/conf/fairscheduler.xml',
  ...
  file { 'spark1_log4j.properties':
    path    => '/home/spkadmin/software/spark-1.0.9-hadoop1/conf/log4j.properties',
  ...
  file { 'spark1_metrics.properties':
    path    => '/home/spkadmin/software/spark-1.0.9-hadoop1/conf/metrics.properties',
  ...
  file { 'spark1_slaves':
    path    => '/home/spkadmin/software/spark-1.0.9-hadoop1/conf/slaves',
  ...
  file { 'spark1_spark-defaults.conf':
    path    => '/home/spkadmin/software/spark-1.0.9-hadoop1/conf/spark-defaults.conf',
  ...
  file { 'spark1_spark-env.sh':
    path    => '/home/spkadmin/software/spark-1.0.9-hadoop1/conf/spark-env.sh',
